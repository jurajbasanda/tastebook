...
const NewRecipe = ({ openComponent,setTitle,setServings,setKeywords,setIngredients,setDirections,setPhoto }) => {
	return (
		<div className={`new-recipe ${openComponent}`}>
            ...
            onChange={(e) => setServings(e.target.value)}
				...
				<div>
					...
					<input type='text' name='keywords' id='keywords' onChange={(e) => setKeywords(e.target.value)} required />
				</div>
				<div>
					<label htmlFor='ingredients'>Ingredients*</label>
					<input type='text' name='ingredients' id='ingredients' onChange={(e) => setIngredients(e.target.value)} required />
				</div>
				<div>
